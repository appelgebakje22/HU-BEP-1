package nl.appelgebakje22.bep.prc2_2;
...
final class MyServlet extends Thread {
	...
	public void run() {
		...
		try {
			System.out.println("Thread " + this.getName() + " will now sleep for 10 seconds!");
			Thread.sleep(10 * 1000L);
			System.out.println("Thread " + this.getName() + " is done sleeping!");
